...
- [x] ~~Basic GitHub Actions CI (fmt, clippy, test) — [#45](https://github.com/coxswain-labs/coxswain/issues/45)~~
- [x] ~~Cluster-backed integration test harness (`crates/coxswain-e2e`) — [#61](https://github.com/coxswain-labs/coxswain/issues/61)~~
- [x] ~~IngressClass filtering — [#1](https://github.com/coxswain-labs/coxswain/issues/1)~~
- [x] ~~`parentRef` matching for HTTPRoute (GEP-724) — [#2](https://github.com/coxswain-labs/coxswain/issues/2)~~
- [x] ~~`ReferenceGrant` for cross-namespace backends (GEP-709) — [#3](https://github.com/coxswain-labs/coxswain/issues/3)~~
- [x] ~~Namespace-scoped watch (`--controller-watch-namespace`) — [#4](https://github.com/coxswain-labs/coxswain/issues/4)~~
- [x] ~~Gateway resource status patching (GEP-1364) — [#5](https://github.com/coxswain-labs/coxswain/issues/5)~~
- [x] ~~Ingress `.status.loadBalancer` patching — [#48](https://github.com/coxswain-labs/coxswain/issues/48)~~
- [x] ~~Default backend for Ingress — [#6](https://github.com/coxswain-labs/coxswain/issues/6)~~
- [x] ~~HTTPRoute header, method, query matching — [#7](https://github.com/coxswain-labs/coxswain/issues/7)~~
- [x] ~~TLS termination for Ingress (`spec.tls`) — [#8](https://github.com/coxswain-labs/coxswain/issues/8)~~
- [x] ~~TLS termination for Gateway API listeners (GEP-2907) — [#9](https://github.com/coxswain-labs/coxswain/issues/9)~~
- [x] ~~Secret watch + hot TLS reload — [#10](https://github.com/coxswain-labs/coxswain/issues/10)~~
- [x] ~~cert-manager integration (both APIs) — [#11](https://github.com/coxswain-labs/coxswain/issues/11)~~
- [x] ~~PROXY protocol v1/v2 support — [#49](https://github.com/coxswain-labs/coxswain/issues/49)~~
- [x] ~~`URLRewrite`, `RequestRedirect`, `RequestHeaderModifier`, `ResponseHeaderModifier` filters (GEP-726, GEP-1323) — [#13](https://github.com/coxswain-labs/coxswain/issues/13)~~
- [x] ~~HTTPRoute `timeouts` field (GEP-1742) — [#14](https://github.com/coxswain-labs/coxswain/issues/14)~~
- [x] ~~Non-default redirect status codes in `RequestRedirect` (303, 307, 308) — [#81](https://github.com/coxswain-labs/coxswain/issues/81)~~
...
- [ ] Implement weighted `backendRef` traffic splitting (`HTTPRouteWeight`) — [#109](https://github.com/coxswain-labs/coxswain/issues/109)
...
- [x] ~~Full Gateway API conformance test suite — all applicable tests passing — [#34](https://github.com/coxswain-labs/coxswain/issues/34)~~
