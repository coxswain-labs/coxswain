...
- **Verification.** The pre-push e2e + conformance gate from `/run-e2e`: routing, tls, status_conditions, provisioning_rbac, resilience, observability, conformance. Reset the cluster between every suite per the run-e2e procedure.
