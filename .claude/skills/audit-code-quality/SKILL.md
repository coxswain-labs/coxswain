...
- **Verification.** The pre-push e2e + conformance gate from `/run-e2e`: ingress, gateway_api, dedicated_proxy, observability, conformance. Reset the cluster between every suite per the run-e2e procedure.
