...
pub const INGRESS_DEFAULT_BACKEND_ONLY: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/fixtures/ingress/default_backend_only.yaml"
);
...
pub const INGRESS_DEFAULT_CLASS: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/fixtures/ingress/default_class.yaml"
);
