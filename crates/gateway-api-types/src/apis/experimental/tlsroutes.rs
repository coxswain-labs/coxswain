//! Generated by kopium from the experimental-channel Gateway API CRD at `config/crd/experimental/gateway.networking.k8s.io_tlsroutes.yaml`.
...
impl Default for TlsRouteUseDefaultGateways {
    fn default() -> Self {
        TlsRouteUseDefaultGateways::All
    }
}
