//! Generated by kopium from the experimental-channel Gateway API CRD at `config/crd/experimental/gateway.networking.k8s.io_udproutes.yaml`.
...
impl Default for UdpRouteUseDefaultGateways {
    fn default() -> Self {
        UdpRouteUseDefaultGateways::All
    }
}
