//! Generated by kopium from the experimental-channel Gateway API CRD at `config/crd/experimental/gateway.networking.k8s.io_gateways.yaml`.
...
impl Default for GatewayAllowedListenersNamespacesFrom {
    fn default() -> Self {
        GatewayAllowedListenersNamespacesFrom::All
    }
}

impl Default for GatewayDefaultScope {
    fn default() -> Self {
        GatewayDefaultScope::All
    }
}

impl Default for GatewayListenersAllowedRoutesNamespacesFrom {
    fn default() -> Self {
        GatewayListenersAllowedRoutesNamespacesFrom::All
    }
}

impl Default for GatewayListenersTlsMode {
    fn default() -> Self {
        GatewayListenersTlsMode::Terminate
    }
}

impl Default for GatewayTlsFrontendDefaultValidationMode {
    fn default() -> Self {
        GatewayTlsFrontendDefaultValidationMode::AllowValidOnly
    }
}

impl Default for GatewayTlsFrontendPerPortTlsValidationMode {
    fn default() -> Self {
        GatewayTlsFrontendPerPortTlsValidationMode::AllowValidOnly
    }
}
