//! Generated by kopium from the experimental-channel Gateway API CRD at `config/crd/experimental/gateway.networking.k8s.io_tcproutes.yaml`.
...
impl Default for TcpRouteUseDefaultGateways {
    fn default() -> Self {
        TcpRouteUseDefaultGateways::All
    }
}
