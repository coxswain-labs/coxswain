//! Generated by kopium from the experimental-channel Gateway API CRD at `config/crd/experimental/gateway.networking.k8s.io_grpcroutes.yaml`.
...
impl Default for GrpcRouteRulesMatchesHeadersType {
    fn default() -> Self {
        GrpcRouteRulesMatchesHeadersType::Exact
    }
}

impl Default for GrpcRouteRulesMatchesMethodType {
    fn default() -> Self {
        GrpcRouteRulesMatchesMethodType::Exact
    }
}

impl Default for GrpcRouteRulesSessionPersistenceCookieConfigLifetimeType {
    fn default() -> Self {
        GrpcRouteRulesSessionPersistenceCookieConfigLifetimeType::Permanent
    }
}

impl Default for GrpcRouteRulesSessionPersistenceType {
    fn default() -> Self {
        GrpcRouteRulesSessionPersistenceType::Cookie
    }
}

impl Default for GrpcRouteUseDefaultGateways {
    fn default() -> Self {
        GrpcRouteUseDefaultGateways::All
    }
}
