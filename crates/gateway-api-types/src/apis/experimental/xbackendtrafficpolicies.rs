//! Generated by kopium from the experimental-channel Gateway API CRD at `config/crd/experimental/gateway.networking.x-k8s.io_xbackendtrafficpolicies.yaml`.
...
impl Default for XBackendTrafficPolicySessionPersistenceCookieConfigLifetimeType {
    fn default() -> Self {
        XBackendTrafficPolicySessionPersistenceCookieConfigLifetimeType::Permanent
    }
}

impl Default for XBackendTrafficPolicySessionPersistenceType {
    fn default() -> Self {
        XBackendTrafficPolicySessionPersistenceType::Cookie
    }
}
