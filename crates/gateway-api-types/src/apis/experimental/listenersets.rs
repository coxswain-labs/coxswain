//! Generated by kopium from the experimental-channel Gateway API CRD at `config/crd/experimental/gateway.networking.k8s.io_listenersets.yaml`.
...
impl Default for ListenerSetListenersAllowedRoutesNamespacesFrom {
    fn default() -> Self {
        ListenerSetListenersAllowedRoutesNamespacesFrom::All
    }
}

impl Default for ListenerSetListenersTlsMode {
    fn default() -> Self {
        ListenerSetListenersTlsMode::Terminate
    }
}
