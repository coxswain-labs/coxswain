//! Table-driven tests for [`crate::cluster::build_cluster_summary`].
//!
//! Cover the four shape combinations called out in issue #205's acceptance
//! criteria: shared-mode only, dedicated-mode only, ingress-only, and a mixed
//! cluster with both kinds of Gateways plus Ingresses.

use crate::cluster::{ClusterSummaryInputs, build_cluster_summary};
use crate::gw_types::v::gateways::{
    Gateway, GatewayInfrastructure, GatewayInfrastructureParametersRef, GatewaySpec, GatewayStatus,
