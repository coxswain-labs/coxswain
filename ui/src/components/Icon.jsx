/**
 * Inline icon set (feather-style, 24×24 stroke icons).
 *
 * Single source of truth for the UI's iconography so every screen draws from
 * the same visual vocabulary. `currentColor` stroke means callers control the
 * color via CSS `color`. Unknown names render nothing.
 */
const PATHS = {
  // server rack — controllers
  server: (
    <>
  ...
  // stacked layers — shared proxy pool
  layers: (
    <>
  ...
  // check — healthy / all-clear
  check: <polyline points="20 6 9 17 4 12" />,
  // alert triangle — a tab/section needs attention
  alert: (
    <>
